...
import search from "../../../../Assets/Illustrations/search.json";
...
class Search extends Component {
  ...
  onHandlePageChange = (events, page) => {
      ...
      <div style={styles.container}>
          ...
          <Grid item xs={3}>
            <FormControl sx={{ minWidth: "100%" }}>
              ...
              <Select
                ...
                label="Category"
                onChange={this.onHandleCategoryChange}
              >
        ...
        {this.state.query.length === 0 ? (
          <Grid container justifyContent="center" alignItems="center">
            <Grid item xs={9}>
              <LottieAnimation lotti={search} height={350} width={350} />
              <Typography style={styles.emptyHeading} align="center">
          ...
          <div>
            <Grid sx={styles.courses} container spacing={2}>
              {this.state.data
                .slice(
                  (this.state.currPage - 1) * 12,
                  (this.state.currPage - 1) * 12 + 12
                )
                .map((details) => {
                  return (
                    <Grid item xs={2}>
            ...
            <Grid container justifyContent="center">
              <Grid item>
                <Pagination
                  count={Math.ceil(this.state.data.length / 12)}
                  variant="outlined"
                  shape="rounded"
